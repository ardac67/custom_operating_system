...
namespace myos
{
    ...
    private:
        ...
        Priority priority;
    public:
        Task(GlobalDescriptorTable *gdt, void entrypoint(),TaskManager *taskManager,Priority priority);
    ...
    private:
        ...
        int tick;
        int currentTaskPriority; // Tracks the priority level of the current task
        int currentTaskIndex; // Tracks the index within that priority level
        int interrupt_count;
    public:
        ...
        int get_keyboard_event(CPUState* cpustate);
